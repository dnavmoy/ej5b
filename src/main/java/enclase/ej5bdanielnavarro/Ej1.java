...
public class Ej1 {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(arraInt);
        System.out.println("Array ordenado \n" + Arrays.toString(arraInt));
      
        
        int numero = preguntarNumero("introduce numero a buscar");
        
        System.out.println("esta en la posicion: "
                + Arrays.binarySearch(arraInt, numero));
    ...
    public static int preguntarNumero(String texto){
          Scanner preguntar = new Scanner(System.in);
        int numero=0;
        try {
            System.out.println(texto);
            numero = preguntar.nextInt();
              preguntar.nextLine();
